# pylint: disable=missing-module-docstring, line-too-long, consider-using-enumerate, missing-function-docstring, invalid-name
"""
* Arcade Elite
...
? If the player's scores are 290, 400 and 500, their rankings after each
? game played would be 4, 3 and 1.
...
! Your function should return an array of whole numbers,
! with each number representing the player's rank after each score.
